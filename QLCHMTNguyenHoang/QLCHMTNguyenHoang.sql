...
Insert into KhachHang(MaKH,TenKH,SoDT,Email,Diachi) values ('KH001',N'Nguyễn Thị A','0909080807','nguyenthia@gmail.com',N'An Giang');
Insert into KhachHang(MaKH,TenKH,SoDT,Email,Diachi) values ('KH002',N'Trần Văn B','0707060605','tranvanb@gmail.com',N'Bắc Giang');
Insert into KhachHang(MaKH,TenKH,SoDT,Email,Diachi) values ('KH003',N'Lê Thị C','0505040403','lethic@gmail.com',N'Hà Giang');

Insert into NhanVien(MaNV,TenNV,Gioitinh,CCCD,SoDT,Diachi,Chucvu) values ('NV001',N'Bùi Văn A',1,'123456789012','0123456789',N'Hậu Giang','Nhân viên kho hàng');
Insert into NhanVien(MaNV,TenNV,Gioitinh,CCCD,SoDT,Diachi,Chucvu) values ('NV002',N'Kim Thị B',0,'123456789012','0123456789',N'Kiên Giang','Nhân viên bán hàng');
Insert into NhanVien(MaNV,TenNV,Gioitinh,CCCD,SoDT,Diachi,Chucvu) values ('NV003',N'Lý Minh C',1,'123456789012','0123456789',N'Tiền Giang','Nhân viên thu ngân');
